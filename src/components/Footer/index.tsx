            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="text-base text-body-color dark:text-body-color-dark mb-8">
                  ...
                  GPS-based technology, providing a seamless and efficient
                  experience for drivers across India.
                </p>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <Link
                      href="/about-us"
                      className="mb-4 inline-block text-base leading-loose text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      About Us
                    </Link>
                  </li>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li className="mb-4 text-base text-body-color dark:text-body-color-dark">
                    Phone: +91 74994 55643
                  </li>
                  <li className="mb-4 text-base text-body-color dark:text-body-color-dark">
                    Email: novacop.rcpit@gmai.com
                  </li>
                  <li className="mb-4 text-base text-body-color dark:text-body-color-dark">
