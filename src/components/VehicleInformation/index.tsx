    ...
    <div className="overflow-x-auto p-10 bg-white">
      <table className="min-w-full text-left text-sm font-light">
        ...
        <tbody className="text-gray-700">
          ...
          <tr className="border-b bg-gray-50">
            <td className="px-6 py-4">Permit Details</td>
            <td className="px-6 py-4">
              Permit No: {permit_details.pmt_no}, Type:{" "}
              {permit_details.permit_type}, Valid Till:{" "}
              {permit_details.permit_valid_upto}
            </td>
          </tr>
          <tr className="border-b">
          ...
          <tr className="border-b bg-gray-50">
            ...
            <td className="px-6 py-4">
              {financer_details.financer_name}, Hypothecation Date:{" "}
              {financer_details.hypothecation_dt}
            </td>
          </tr>
        </tbody>
      </table>
